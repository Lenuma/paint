...
public class Paint extends JFrame {
	...
	public Paint() {
		...
		couleur1.setSelected(true); //Initialise la fenêtre avec ce bouton de sélectionné
		...
		//Cr�ation d'un toggle group et ajout des boutons
		...
		// Défnition de la taille du trait
	...
	private class surfaceDessin extends JPanel {
		...
		protected void paintComponent(Graphics g) {
			...
			// Graphics2D nécessaire pour utiliser "BasicSroke()"
